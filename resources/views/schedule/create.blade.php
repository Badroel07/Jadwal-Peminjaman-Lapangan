    ...
    <div class="column is-6-desktop is-8-tablet">
        <div class="card">
            <header class="card-header has-background-dark">
                <p class="card-header-title is-size-4 has-text-primary">
                ...
                <form action="{{ route('schedule.confirm') }}" method="POST">
                    ...
                    <div class="field">
                        ...
                        <div class="control has-icons-left">
                            <input class="input" type="text" name="nama_peminjam" value="{{ old('nama_peminjam') }}" placeholder="Contoh: Organisasi BEM" required>
                    ...
                    <div class="field">
                        ...
                        <div class="control has-icons-left">
                            <input class="input" type="text" name="nama_kegiatan" value="{{ old('nama_kegiatan') }}" placeholder="Contoh: Latihan Futsal Mingguan" required>
                            <span class="icon is-small is-left">
                    ...
                    <div class="columns">
                        <div class="column is-12">
                            <div class="field">
                                ...
                                <div class="control has-icons-left">
                                    <input class="input datepicker" type="text" name="tanggal" value="{{ old('tanggal') }}" required placeholder="Pilih Tanggal">
                                    <span class="icon is-small is-left">
