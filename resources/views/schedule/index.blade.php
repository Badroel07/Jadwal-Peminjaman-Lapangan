...
@section('content')
    <div class="columns is-centered">
        <div class="column is-12">
            ...
            <!-- Hero Section -->
            <div class="hero is-small hero-gradient mb-6">
                <div class="hero-body">
                    <div class="level">
            ...
            <div class="level mb-5 px-2">
                <div class="level-left">
                    <h2 class="title is-4 has-text-white">
                        <span class="icon-text">
                            <span class="icon has-text-primary mr-2"><i class="fas fa-list-ul"></i></span>
            ...
            <div class="table-wrapper">
                ...
                @else
                    <div class="has-text-centered py-6 flat-container">
